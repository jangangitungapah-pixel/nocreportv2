...
export function ImpactBuilder({ existing = EMPTY_IMPACT_VALUES, onApply }) {
  ...
  return (
    <div className="generator-impact-builder border-b border-[var(--border-subtle)] bg-[var(--surface-muted)] p-3 xl:border-b-0 xl:bg-transparent xl:px-0 xl:pb-1.5 xl:pt-1">
      <div
